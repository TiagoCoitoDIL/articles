...
Big goal of PGA Tour is to preserve his history and provide this history to all the uers in all the platforms. 

They had also a media asset management system on-premesis. As they began to grow all the content that they had needed to reach many more people, so they had to make all the content available over the internet.

So they started using AWS to put everything in the cloud.
They choosed AWS because allows them to stream big events using [AWS Elemental MediaConnect](https://aws.amazon.com/mediaconnect/?nc1=h_ls) and is also scalable when there is a lot of traffic, expertises in video production in the cloud, able to retire the on-premesis and put on cloud for business continuity and security.
...
To summurizere we can take three takeawys:
