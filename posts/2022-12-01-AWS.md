...
He forced the idea that asynchronous is natural and synchronous is just an ilusion. It was a funny way to introduce to us the theme of the Keynote.
...
Not just about patterns but also many articles and videos on how Amazon builds and operates software.
...
Moving on, Vogels talked Virtual Realiy, he explains that the world is multidimentional and today when we want to buy something online we are looking to static pictures and we don't know if we will like it or not, so the future experience to the customer will be using virtual realty. 

!cAmazon virtual reality](../Images/AWS/day5/virtualReality.gif)

Not just to know if the pair of shoes fit on our feet but also if some furniture looks good on our home.

The issue is that it required a thousand pictures to process and also need to know the space around.

To show how Unreal is being used their technology to create the experiences of the future, Nathan Thomas the VP of Unreal Engine came up to the stage and demonstrated the using aws.

![Unreal](../Images/AWS/day5/IMG_8783.jpeg)

Nathan show us how they use the cloud on AWS to accelate the process of creating and building their 3D objects.
After the explanation he announced [RealityScan](https://www.unrealengine.com/en-US/realityscan) that enables us to create high-fidelity 3D models using just our phone or tablet.

![RealityScan](../Images/AWS/day5/RealityScan.png)

Then Nathan explain how he use [AWS Ambit Scenario Designer](https://aws.amazon.com/blogs/industries/create-3d-content-for-simulation-using-ambit/) to create in real-time 3D models.
...
To run massive spatial simulations without managing infrastructure, AWS announced two days ago [AWS SimSpace Weaver](https://aws.amazon.com/blogs/aws/new-aws-simspace-weaver-build-large-scale-spatial-simulations-in-the-cloud/) and Vogels dove a little bit deeper into this and finalized the keynote after that.
...
Being in this big room with those big screen was a really amazing experience and the news were also amazing, can't wait to put my hands on AWS Application Composer.
